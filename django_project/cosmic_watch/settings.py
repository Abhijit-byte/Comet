...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,comet-production-6342.up.railway.app').split(',')
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': ["redis://default:uGZZbzHURouQmJcMxoVTgnrRtFsqwhIW@shuttle.proxy.rlwy.net:27893"],
        },
    },
}
